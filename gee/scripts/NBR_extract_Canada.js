...
var startYear = 1991;
var endYear = 2019;
var startDay = '07-01'; // what is the beginning of date filter | month-day
var endDay = '10-01'; // what is the end of date filter | month-day
var aoi = geometry;
...
Export.table.toDrive({
  ...
  folder: "worldfire3",
  fileNamePrefix: ("nbr_extract_Canada")
});

Export.image.toDrive({
  image: NBRstack,
  description: 'nbr_sample_Canada',
  folder: 'worldfire3',
  scale: 30,
  fileFormat: 'GeoTIFF',
  region: geometry2,
